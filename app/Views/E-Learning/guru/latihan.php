...
<div class="container">
    <h1 class="text-center" style="font-family:verdana">MENU LATIHAN</h1>
    <h5 class="text-center">Silahkan pilih jenis pelajaran / Buat baru</h5>
    <a href="<?= base_url()  ?>/guru/buat_soal" class="btn btn-primary">Buat Soal Baru</a>
    <hr>
            ...
            <div class="col-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/guru/latihan_soal/<?= $data_materi['id_materi'] ?>" class="btn btn-primary">Lihat</a>
                    </div>
