            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h2 class="card-title">E-Learning</h2>
                        <br><br>
                        <p class="card-text" style="text-indent: 0.5in;">E-Learning adalah sebuah platform belajar online yang menyediakan beberapa materi yang bagus.</p>
                        <br><br>
                      </div>
                    </div>
